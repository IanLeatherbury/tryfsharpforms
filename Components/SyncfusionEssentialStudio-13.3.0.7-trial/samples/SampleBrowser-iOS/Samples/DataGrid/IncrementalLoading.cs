...
namespace SampleBrowser
{
	public class IncrementalLoading:SampleView
	{
		...
		public override void LayoutSubviews ()
		{
			...
			viewmodel.border.Frame = new CGRect (0, this.Frame.Height- 60, this.Frame.Width, 70);
			viewmodel.loaderindicator.Frame = new CGRect (50, 25, 20, 20);
			viewmodel.lable.Frame = new CGRect (80, 0, this.Frame.Width, 70);
			viewmodel.lable.TextColor = UIColor.White;
			base.LayoutSubviews ();
		}
	}
}
