...
using System.Text;
using Syncfusion.Data.Portable.Extensions;
using Syncfusion.Data.Portable;
...
namespace SampleBrowser
{
	...
	public class AutoRowHeightViewModel : INotifyPropertyChanged
	{
		...
		{
			EmployeeInformationRepository emp = new EmployeeInformationRepository ();
			employeeInformation = emp.GetEmployeeDetails (50);
		}
	...
	public class SalesViewModel
	{
		...
		public ObservableCollection<SalesByDate> DailySalesDetails
		{
			get {
				if (dailySalesDetails == null)
					return new SalesRepository().GetSalesDetailsByDay(60);
				else
					return dailySalesDetails;
			}
		}
